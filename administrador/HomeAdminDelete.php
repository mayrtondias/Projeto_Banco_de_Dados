...
<html>
    ...
    <body>
        ...
        <center>
            <div id="tres">
                <form method="POST" action="HomeAdminValDelete.php" >
                    <?php
                        ...
                        while($registro = pg_fetch_array($resultado)){
                            ...
                            if(($contador>=($qtdeResult*10))&&($contador<($qtdeResult*10+10))){
                                  ...
                                  <tr>
                                    ...
                                    <td><button type="submit" name="selecionado" value="<?php echo $registro['nome']; ?>" >OK</button></td>
                                  </tr>
                                <?php
            ...
            <form method="POST" action="HomeAdminDelete.php" >
                    <?php
